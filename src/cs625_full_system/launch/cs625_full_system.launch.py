# 文件：cs625_full_system/launch/cs625_full_system.launch.py
...
def generate_launch_description():
    ...
    driver_args_dict = {
        ...
        # 其它如 fake_sensor_commands/headless_mode 等，
        # 如果 cs625_driver.launch.py 也支持，也可以一并传下去
    }
    ...
    # ===== 2. MoveIt 核心入口（cs625_moveit.launch.py） =====
    moveit_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            PathJoinSubstitution([
                FindPackageShare('elite_cs625_moveit_config'),
                'launch',
                'cs625_moveit.launch.py'
            ])
        ]),
